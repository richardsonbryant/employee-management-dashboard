<html lang="en">
  ...
  <body class="bg-gray-100">
    <!-- Top Navigation Bar - Kept unchanged -->
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="heading-wrapper">
                ...
                <h2 class="card-title mx-auto">Izin Cuti</h2>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{route('addUser.post')}}" method="post">
                    ...
                    <div class="form-group-date mb-4">
                        <div>
                            <label for="start_off_date" class="form-label required-field">Tanggal Mulai Cuti</label>
                            <input type="date" class="form-control" id="start_off_date" name="start_off_date" required>
                            <div class="form-text">Tanggal pertama cuti</div>
                        </div>
                        <div>
                            <label for="end_off_date" class="form-label required-field">Tanggal Berakhir Cuti</label>
                            <input type="date" class="form-control" id="end_off_date" name="end_off_date" required>
                            <div class="form-text">Tanggal terakhir cuti</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="reason" class="form-label required-field">Alasan Cuti</label>
                        <textarea class="form-control" id="reason" name="reason" rows="3" required placeholder="Jelaskan alasan cuti anda secara detail"></textarea>
                    </div>
