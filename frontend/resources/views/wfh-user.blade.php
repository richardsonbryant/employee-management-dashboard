    ...
    <div class="container">
        <div class="card">
            ...
            <div class="heading-wrapper">
                ...
                <h2 class="card-title mx-auto">Izin WFH</h2>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{route('addWfhUser.post')}}" method="post">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="form-group-date mb-4">
                        <div>
                            <label for="start_off_date" class="form-label required-field">Tanggal Mulai WFH</label>
                            <input type="date" class="form-control" id="start_off_date" name="start_off_date" required>
                            <div class="form-text">Tanggal pertama WFH</div>
                        </div>
                        <div>
                            <label for="end_off_date" class="form-label required-field">Tanggal Berakhir WFH</label>
                            <input type="date" class="form-control" id="end_off_date" name="end_off_date" required>
                            <div class="form-text">Tanggal terakhir WFH</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="reason" class="form-label required-field">Alasan WFH</label>
                        <textarea class="form-control" id="reason" name="reason" rows="3" required placeholder="Jelaskan alasan mengapa anda perlu bekerja dari rumah"></textarea>
                    </div>
