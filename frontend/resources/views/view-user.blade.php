...
<body class="bg-gray-100">
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-center align-items-center mb-3 position-relative">
            <a href="{{ route('summaryEmployee') }}" class="back-button position-absolute start-0">←</a>
            <h3 class ="header-name">{{ $user['name'] }}'s Information </h3>
        </div>

        <form action="{{ route('viewUserData', $user['email']) }}" method="GET" class="mb-3">
            <select name="year" id="yearSelect" class="form-select mb-2" onchange="this.form.submit()">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="{{ route('exportUserData', ['email' => $user['email'], 'year' => request('year'), 'month' => request('month'), 'requestType' => request('requestType')]) }}" class="btn btn-primary">
                Export to PDF
            </a>
        </div>
        ...
        <table class="table table-content" style="table-layout: fixed;">
            ...
            <tbody>
                ...
                data-href="{{ route('EditUser', ['id' => $leave['id'], 'from' => 'view-user']) }}" 
                ...
                <h5 class="text-xl font-semibold !text-black"> <u> From Home Requests </u></h5>
                <table class="table table-content" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        data-href="{{ route('EditWfh', ['id' => $wfh['id'], 'from' => 'view-user']) }}" 
                ...
                <table class="table  table-content" style="table-layout: fixed;">
                    ...
                    <tbody>
                        ...
                        data-href="{{ route('EditSick', ['id' => $sick['id'], 'from' => 'view-user']) }}" 
                        style="cursor: pointer;">
