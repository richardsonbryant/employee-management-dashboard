    ...
    <div class="container">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <h5 class="mb-0 fw-bold">Izin WFH</h5>
          ...
          <div class="card-body">
            ...
            <form action="{{ route('handleWfhData.post', ['id' => $user['id']]) }}" method="POST">
              @csrf
              ...
              <div class="leave-info">
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="start_off_date" class="form-label">Tanggal Mulai WFH</label>
                      <div class="input-group">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="end_off_date" class="form-label">Tanggal Berakhir WFH</label>
                      <div class="input-group">
                ...
                <div class="mb-3">
                  <label for="total_off_day" class="form-label">Total Hari WFH</label>
                  <div class="input-group">
              ...
              @else
                <div class="mb-3">
                  <label for="approvalStatus" class="form-label">Status Persetujuan</label>
                  <div class="input-group">
